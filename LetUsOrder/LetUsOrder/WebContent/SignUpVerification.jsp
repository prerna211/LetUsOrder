...
<body id="Home">
    ...
    <div class="container" style="padding-top:270px;">
        <div class="mx-auto py-4 px-3 text-center col-12 col-md-8 col-xl-6 col-lg-7 bg-light" style="border:0.15rem solid #fca118;border-radius:20px;background-color:rgb(250,245,239);">
        	<h3 class="mx-n4" style="font-size:28px;font-weight:bold;">Account Verification</h3>
        	<div class="mt-3 checkOTP">
        		A verification code has been sent to your email.<br>
        		<form action="VerifyOTP" method="post">
        			<input type="text" id="page" name="page" value="SignUpVerification" style="display:none;">
	...
	try
	{
		if((boolean)session.getAttribute("OTPSent")==true)
		{
			...
			else
			{
				...
				request.getSession(true).setAttribute("attemptsOver",2);
