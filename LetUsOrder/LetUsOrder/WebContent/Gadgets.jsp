...
<head>
    ...
    <title>LetUsOrder Gadgets&Accessories</title>
        ...
        $(document).ready(function()
		{
            ...
            $(".subfilter span").click(function()
            {
            	...
            	if($(this).text()=="All")
            	{
            		...
            		if($(".cameras:visible,.fitnessbands:visible,.earwears:visible,.smartwatches:visible,.speakers:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Cameras")
            	{
            		$(".fitnessbands,.earwears,.smartwatches,.speakers").hide(300);
            		for(var j=0; j<$(".cameras").length; j++)
            		{
            			if($(".cameras:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".cameras:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".cameras:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".cameras:eq("+j+")").hide(300);
            			}
            		}
            		if($(".cameras:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Fitness Bands")
            	{
            		$(".cameras,.earwears,.smartwatches,.speakers").hide(300);
            		for(var j=0; j<$(".fitnessbands").length; j++)
            		{
            			if($(".fitnessbands:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".fitnessbands:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".fitnessbands:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".fitnessbands:eq("+j+")").hide(300);
            			}
            		}
            		if($(".fitnessbands:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Ear Wears")
            	{
            		$(".cameras,.fitnessbands,.smartwatches,.speakers").hide(300);
            		for(var j=0; j<$(".earwears").length; j++)
            		{
            			if($(".earwears:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".earwears:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".earwears:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".earwears:eq("+j+")").hide(300);
            			}
            		}
            		if($(".earwears:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Smartwatches")
            	{
            		$(".cameras,.fitnessbands,.earwears,.speakers").hide(300);
            		for(var j=0; j<$(".smartwatches").length; j++)
            		{
            			if($(".smartwatches:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".smartwatches:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".smartwatches:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".smartwatches:eq("+j+")").hide(300);
            			}
            		}
            		if($(".smartwatches:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Speakers")
            	{
            		$(".cameras,.fitnessbands,.earwears,.smartwatches").hide(300);
            		for(var j=0; j<$(".speakers").length; j++)
            		{
            			if($(".speakers:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".speakers:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".speakers:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".speakers:eq("+j+")").hide(300);
            			}
            		}
            		if($(".speakers:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            ...
            $(".search").on("keyup", function() 
            {
                ...
                else if($(".subfilter span.badge-primary").text()=="Cameras")
                {
                	$(".items > div.cameras").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Fitness Bands")
                {
                	$(".items > div.fitnessbands").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Ear Wears")
                {
                	$(".items > div.earwears").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Smartwatches")
                {
                	$(".items > div.smartwatches").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Speakers")
                {
                	$(".items > div.speakers").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
...
<body id="Home">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark py-0">
        ...
        <a class="navbar-text text-white w-auto font-weight-bolder" href="Home" style="position:static;font-size:32px;text-decoration:none;">
			LetUsOrder<span class="badge badge-pill badge-light ml-n4" style="font-size:10px;position:absolute;">Gadgets&Accessories</span>
		</a>
                ...
                <div class="tab-content">
                    <div id="logMenu" class="tab-pane fade px-3 py-2">
                        <form action="InvalidCredentials" class="was-validated" method="post">
                            ...
                            <input type="text" id="page" name="page" value="GadgetsAndAccessories" style="display:none;">
...
%>
	...
	<div class="container pt-4">
        <div class="text-center col-12 col-md-12 col-xl-12 col-lg-12">
            <input class="form-control search" placeholder="🔍 Search here for Gadgets & Accessories...">
		</div>
		<div class="text-center col-12 col-md-12 col-xl-12 col-lg-12 mt-2 text-white subfilter" style="font-size:20px;">
			...
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Cameras</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Fitness Bands</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Speakers</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Ear Wears</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Smartwatches</span>
		</div>
...
<%
	HashMap<String,ResultSet> r=d.getGadgets();
				...
				out.println("<div class='row mx-auto w-100 "+i+"'>");
					...
					out.println("<div class='col-9 col-md-10 col-xl-10 col-lg-10 bg-light mt-3 pt-3' style='border-radius:0px 10px 10px 0px;'>");
						...
						out.println("<form action='ItemConfirmation' method='post' onsubmit='return true'>");
							...
							out.println("<input type='text' name='page' value='Gadgets' style='display:none;'>");
