...
<head>
    ...
    <title>LetUsOrder Clothing</title>
        ...
        $(document).ready(function()
		{
            ...
            $(".subfilter span").click(function()
            {
            	...
            	if($(this).text()=="All")
            	{
            		...
            		if($(".bottomwear:visible,.festivewear:visible,.innerwear:visible,.sleepwear:visible,.topwear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Bottom Wear")
            	{
            		$(".festivewear,.innerwear,.sleepwear,.topwear").hide(300);
            		for(var j=0; j<$(".bottomwear").length; j++)
            		{
            			if($(".bottomwear:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".bottomwear:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".bottomwear:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".bottomwear:eq("+j+")").hide(300);
            			}
            		}
            		if($(".bottomwear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Festive Wear")
            	{
            		$(".bottomwear,.innerwear,.sleepwear,.topwear").hide(300);
            		for(var j=0; j<$(".festivewear").length; j++)
            		{
            			if($(".festivewear:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".festivewear:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".festivewear:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".festivewear:eq("+j+")").hide(300);
            			}
            		}
            		if($(".festivewear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Inner Wear")
            	{
            		$(".bottomwear,.festivewear,.sleepwear,.topwear").hide(300);
            		for(var j=0; j<$(".innerwear").length; j++)
            		{
            			if($(".innerwear:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".innerwear:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".innerwear:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".innerwear:eq("+j+")").hide(300);
            			}
            		}
            		if($(".innerwear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Sleep Wear")
            	{
            		$(".bottomwear,.festivewear,.innerwear,.topwear").hide(300);
            		for(var j=0; j<$(".sleepwear").length; j++)
            		{
            			if($(".sleepwear:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".sleepwear:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".sleepwear:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".sleepwear:eq("+j+")").hide(300);
            			}
            		}
            		if($(".sleepwear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Top Wear")
            	{
            		$(".bottomwear,.festivewear,.innerwear,.sleepwear").hide(300);
            		for(var j=0; j<$(".topwear").length; j++)
            		{
            			if($(".topwear:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".topwear:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".topwear:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".topwear:eq("+j+")").hide(300);
            			}
            		}
            		if($(".topwear:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            ...
            $(".search").on("keyup", function() 
            {
                ...
                else if($(".subfilter span.badge-primary").text()=="Bottom Wear")
                {
                	$(".items > div.bottomwear").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Festive Wear")
                {
                	$(".items > div.festivewear").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Inner Wear")
                {
                	$(".items > div.innerwear").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Sleep Wear")
                {
                	$(".items > div.sleepwear").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Top Wear")
                {
                	$(".items > div.topwear").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
...
<body id="Home">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark py-0">
        ...
        <a class="navbar-text text-white w-auto font-weight-bolder" href="Home" style="position:static;font-size:32px;text-decoration:none;">
			LetUsOrder<span class="badge badge-pill badge-light ml-n4" style="font-size:10px;position:absolute;">Clothing</span>
		</a>
                ...
                <div class="tab-content">
                    <div id="logMenu" class="tab-pane fade px-3 py-2">
                        <form action="InvalidCredentials" class="was-validated" method="post">
                            ...
                            <input type="text" id="page" name="page" value="Clothing" style="display:none;">
...
%>
	<div id="demo" class="carousel slide w-100 mx-auto" data-ride="carousel" style="margin-top:64px;">
    	...
    	<div class="carousel-inner">
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture1.JPG" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture8.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item active">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture7.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture2.JPG" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture8.jpg" class="w-100" style="object-fit:cover;">
      		</div>
	...
	<div class="container pt-4">
        <div class="text-center col-12 col-md-12 col-xl-12 col-lg-12">
            <input class="form-control search" placeholder="🔍 Search here for Clothing Items...">
		</div>
		<div class="text-center col-12 col-md-12 col-xl-12 col-lg-12 mt-2 text-white subfilter" style="font-size:20px;">
			...
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Top Wear</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Inner Wear</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Sleep Wear</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Festive Wear</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Bottom Wear</span>
		</div>
...
<%
	HashMap<String,ResultSet> r=d.getClothing();
				...
				out.println("<div class='row mx-auto w-100 "+i+"'>");
					...
					out.println("<div class='col-9 col-md-10 col-xl-10 col-lg-10 bg-light mt-3 pt-3' style='border-radius:0px 10px 10px 0px;'>");
						...
						out.println("<form action='ItemConfirmation' method='post' onsubmit='return true'>");
							...
							out.println("<input type='text' name='page' value='Clothing' style='display:none;'>");
							...
							if(!r.get(i).getString(7).equals(""))
							{
								...
								out.println("<p class='mt-1'>Sold By : <a href='Shops#Clothing'>"+r.get(i).getString(7)+"</a> in "+r.get(i).getString(6)+"</p>");
							}
							else
							{
