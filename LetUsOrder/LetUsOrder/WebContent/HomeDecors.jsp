...
<head>
    ...
    <title>LetUsOrder Home&Decors</title>
        ...
        $(document).ready(function()
		{
            ...
            $(".subfilter span").click(function()
            {
            	...
            	if($(this).text()=="All")
            	{
            		...
            		if($(".homegarden:visible,.spiritual:visible,.tabledecor:visible,.wallaccents:visible,.wallart:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Home Garden")
            	{
            		$(".spiritual,.tabledecor,.wallaccents,.wallart").hide(300);
            		for(var j=0; j<$(".homegarden").length; j++)
            		{
            			if($(".homegarden:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".homegarden:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".homegarden:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".homegarden:eq("+j+")").hide(300);
            			}
            		}
            		if($(".homegarden:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Spiritual")
            	{
            		$(".homegarden,.tabledecor,.wallaccents,.wallart").hide(300);
            		for(var j=0; j<$(".spiritual").length; j++)
            		{
            			if($(".spiritual:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".spiritual:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".spiritual:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".spiritual:eq("+j+")").hide(300);
            			}
            		}
            		if($(".spiritual:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Table Decor")
            	{
            		$(".homegarden,.spiritual,.wallaccents,.wallart").hide(300);
            		for(var j=0; j<$(".tabledecor").length; j++)
            		{
            			if($(".tabledecor:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".tabledecor:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".tabledecor:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".tabledecor:eq("+j+")").hide(300);
            			}
            		}
            		if($(".tabledecor:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Wall Accents")
            	{
            		$(".homegarden,.spiritual,.tabledecor,.wallart").hide(300);
            		for(var j=0; j<$(".wallaccents").length; j++)
            		{
            			if($(".wallaccents:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".wallaccents:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".wallaccents:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".wallaccents:eq("+j+")").hide(300);
            			}
            		}
            		if($(".wallaccents:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Wall Art")
            	{
            		$(".homegarden,.spiritual,.tabledecor,.wallaccents").hide(300);
            		for(var j=0; j<$(".wallart").length; j++)
            		{
            			if($(".wallart:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".wallart:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".wallart:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".wallart:eq("+j+")").hide(300);
            			}
            		}
            		if($(".wallart:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            ...
            $(".search").on("keyup", function() 
            {
                ...
                else if($(".subfilter span.badge-primary").text()=="Home Garden")
                {
                	$(".items > div.homegarden").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Spiritual")
                {
                	$(".items > div.spiritual").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Table Decor")
                {
                	$(".items > div.tabledecor").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Wall Accents")
                {
                	$(".items > div.wallaccents").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Wall Art")
                {
                	$(".items > div.wallart").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
...
<body id="Home">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark py-0">
        ...
        <a class="navbar-text text-white w-auto font-weight-bolder" href="Home" style="position:static;font-size:32px;text-decoration:none;">
			LetUsOrder<span class="badge badge-pill badge-light ml-n4" style="font-size:10px;position:absolute;">Home&Decors</span>
		</a>
                ...
                <div class="tab-content">
                    <div id="logMenu" class="tab-pane fade px-3 py-2">
                        <form action="InvalidCredentials" class="was-validated" method="post">
                            ...
                            <input type="text" id="page" name="page" value="HomeAndDecors" style="display:none;">
...
%>
	...
	<div class="container pt-4">
        <div class="text-center col-12 col-md-12 col-xl-12 col-lg-12">
            <input class="form-control search" placeholder="🔍 Search here for Home & Decor Products...">
		</div>
		<div class="text-center col-12 col-md-12 col-xl-12 col-lg-12 mt-2 text-white subfilter" style="font-size:20px;">
			...
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Wall Art</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Spiritual</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Wall Accents</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Table Decor</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Home Garden</span>
		</div>
...
<%
	HashMap<String,ResultSet> r=d.getHomeAndDecors();
				...
				out.println("<div class='row mx-auto w-100 "+i+"'>");
					...
					out.println("<div class='col-9 col-md-10 col-xl-10 col-lg-10 bg-light mt-3 pt-3' style='border-radius:0px 10px 10px 0px;'>");
						...
						out.println("<form action='ItemConfirmation' method='post' onsubmit='return true'>");
							...
							out.println("<input type='text' name='page' value='HomeDecors' style='display:none;'>");
							...
							if(!r.get(i).getString(7).equals(""))
							{
								...
								out.println("<p class='mt-1'>Sold By : <a href='Shops#HomeAndDecors'>"+r.get(i).getString(7)+"</a> in "+r.get(i).getString(6)+"</p>");
							}
							else
							{
