...
<head>
    ...
    <title>LetUsOrder Groceries</title>
        ...
        $(document).ready(function()
		{
            ...
            $(".subfilter span").click(function()
            {
            	...
            	if($(this).text()=="All")
            	{
            		...
            		if($(".beautyandhygiene:visible,.cleaningandhousehold:visible,.fruitsandvegetables:visible,.masksandgloves:visible,.snacks:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Beauty And Hygiene")
            	{
            		$(".cleaningandhousehold,.fruitsandvegetables,.masksandgloves,.snacks").hide(300);
            		for(var j=0; j<$(".beautyandhygiene").length; j++)
            		{
            			if($(".beautyandhygiene:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".beautyandhygiene:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".beautyandhygiene:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".beautyandhygiene:eq("+j+")").hide(300);
            			}
            		}
            		if($(".beautyandhygiene:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Cleaning And Household")
            	{
            		$(".beautyandhygiene,.fruitsandvegetables,.masksandgloves,.snacks").hide(300);
            		for(var j=0; j<$(".cleaningandhousehold").length; j++)
            		{
            			if($(".cleaningandhousehold:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".cleaningandhousehold:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".cleaningandhousehold:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".cleaningandhousehold:eq("+j+")").hide(300);
            			}
            		}
            		if($(".cleaningandhousehold:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Fruits And Vegetables")
            	{
            		$(".beautyandhygiene,.cleaningandhousehold,.masksandgloves,.snacks").hide(300);
            		for(var j=0; j<$(".fruitsandvegetables").length; j++)
            		{
            			if($(".fruitsandvegetables:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".fruitsandvegetables:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".fruitsandvegetables:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".fruitsandvegetables:eq("+j+")").hide(300);
            			}
            		}
            		if($(".fruitsandvegetables:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Masks And Gloves")
            	{
            		$(".beautyandhygiene,.cleaningandhousehold,.fruitsandvegetables,.snacks").hide(300);
            		for(var j=0; j<$(".masksandgloves").length; j++)
            		{
            			if($(".masksandgloves:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".masksandgloves:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".masksandgloves:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".masksandgloves:eq("+j+")").hide(300);
            			}
            		}
            		if($(".masksandgloves:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            	...
            	else if($(this).text()=="Snacks")
            	{
            		$(".beautyandhygiene,.cleaningandhousehold,.fruitsandvegetables,.masksandgloves").hide(300);
            		for(var j=0; j<$(".snacks").length; j++)
            		{
            			if($(".snacks:eq("+j+")").children().text().toLowerCase().indexOf(value) > -1 && $(".snacks:eq("+j+")").children().text().toLowerCase().indexOf(city) > -1)
            			{
            				$(".snacks:eq("+j+")").show(300);
            			}
            			else
            			{
            				$(".snacks:eq("+j+")").hide(300);
            			}
            		}
            		if($(".snacks:visible").length==0)
            		{
            			$(".noResults").show(300);
            		}
            		else
            ...
            $(".search").on("keyup", function() 
            {
                ...
                else if($(".subfilter span.badge-primary").text()=="Beauty And Hygiene")
                {
                	$(".items > div.beautyandhygiene").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Cleaning And Household")
                {
                	$(".items > div.cleaningandhousehold").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Fruits And Vegetables")
                {
                	$(".items > div.fruitsandvegetables").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Masks And Gloves")
                {
                	$(".items > div.masksandgloves").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
                else if($(".subfilter span.badge-primary").text()=="Snacks")
                {
                	$(".items > div.snacks").filter(function() 
                    {
                		$(this).toggle($(this).children().text().toLowerCase().indexOf(value) > -1 && $(this).children().text().toLowerCase().indexOf(city) > -1);
                	});
                }
...
<body id="Home">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark py-0">
        ...
        <a class="navbar-text text-white w-auto font-weight-bolder" href="Home" style="position:static;font-size:32px;text-decoration:none;">
			LetUsOrder<span class="badge badge-pill badge-light ml-n4" style="font-size:10px;position:absolute;">Groceries</span>
		</a>
                ...
                <div class="tab-content">
                    <div id="logMenu" class="tab-pane fade px-3 py-2">
                        <form action="InvalidCredentials" class="was-validated" method="post">
                            ...
                            <input type="text" id="page" name="page" value="Groceries" style="display:none;">
...
%>
	<div id="demo" class="carousel slide w-100 mx-auto" data-ride="carousel" style="margin-top:64px;">
    	...
    	<div class="carousel-inner">
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture12.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture13.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item active">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture5.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture10.jpg" class="w-100" style="object-fit:cover;">
      		</div>
      		<div class="carousel-item">
        		<img src="https://raw.githubusercontent.com/iSingh-11/github-git/master/Capture11.jpg" class="w-100" style="object-fit:cover;">
      		</div>
   	 	</div>
  	...
  	<div id="mySidenav" class="sidenav">
  		...
  		<div class="down card-body mx-auto" style="display:none;font-size:18px;background-color:white;width:205px;height:150px;border-radius:0px 0px 5px 5px;">
        	<ul>
            	<li style="margin-left:-25px;margin-top:-15px;cursor:pointer;"><a href="Electronics" class='text-dark'>Appliances</a></li>
                <li style="margin-left:-25px;cursor:pointer;"><a href="Electronics" class='text-dark'>Laptops</a></li>
                <li style="margin-left:-25px;cursor:pointer;"><a href="Electronics" class='text-dark'>Smartphones</a></li>
                <li style="margin-left:-25px;cursor:pointer;"><a href="Electronics" class='text-dark'>Lights</a></li>
                <li style="margin-left:-25px;cursor:pointer;"><a href="Electronics" class='text-dark'>SmartTV</a></li>
            </ul>
        </div>
  		<div class="cat mt-2 mx-auto" style="cursor:pointer;font-size:21px;background-color:white;width:205px;height:32px;border-radius:5px 5px 5px 5px;">
	...
	<div class="container pt-4">
        <div class="text-center col-12 col-md-12 col-xl-12 col-lg-12">
            <input class="form-control search" placeholder="🔍 Search here for Grocery Items...">
		</div>
		<div class="text-center col-12 col-md-12 col-xl-12 col-lg-12 mt-2 text-white subfilter" style="font-size:20px;">
			...
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Snacks</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Beauty And Hygiene</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Masks And Gloves</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Fruits And Vegetables</span>
			<span class="badge badge-pill badge-light" style="cursor:pointer;">Cleaning And Household</span>
		</div>
...
<%
	HashMap<String,ResultSet> r=d.getGroceries();
				...
				out.println("<div class='row mx-auto w-100 "+i+"'>");
					...
					out.println("<div class='col-9 col-md-10 col-xl-10 col-lg-10 bg-light mt-3 pt-3' style='border-radius:0px 10px 10px 0px;'>");
						...
						out.println("<form action='ItemConfirmation' method='post' onsubmit='return true'>");
							...
							out.println("<input type='text' name='page' value='Groceries' style='display:none;'>");
							...
							if(!r.get(i).getString(7).equals(""))
							{
								...
								out.println("<p class='mt-1'>Sold By : <a href='Shops#Groceries'>"+r.get(i).getString(7)+"</a> in "+r.get(i).getString(6)+"</p>");
							}
							else
							{
